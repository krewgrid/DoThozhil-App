  ...
  return (
    <StyledWrapper>
      <div className="glass-radio-group">
        <input type="radio" name="plan" id="glass-silver" checked={value === 'silver'} onChange={() => onChange('silver')} />
        <label htmlFor="glass-silver">Silver</label>
        
        <input type="radio" name="plan" id="glass-gold" checked={value === 'gold'} onChange={() => onChange('gold')} />
        <label htmlFor="glass-gold">Gold</label>
        
        <input type="radio" name="plan" id="glass-platinum" checked={value === 'platinum'} onChange={() => onChange('platinum')} />
